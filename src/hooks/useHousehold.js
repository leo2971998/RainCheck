...
import { spendingBaseline } from '../engine/spending-baseline.js';
import { activitySummary } from '../engine/weekly-budget.js';
...
const sampleSpending = spendingBaseline(sampleSnapshot, sampleHousehold.today);

const SAMPLE = {
  household: { ...sampleHousehold, spendingPeriod: 'calendar-month',
    allowances: sampleSpending.allowances, spendingEvidence: sampleSpending.evidence,
    activity: activitySummary(sampleSnapshot, sampleHousehold.today) },
