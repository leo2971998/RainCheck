      ...
      <div className="grid g32">
        <div className="grid" style={{ gap: 18 }}>
          <div className="card">
            ...
            <div className="row between fine"><span><span className="dot" style={{ background: 'var(--accent)' }}></span> Saved {money(h.goal.saved)}</span><span><span className="dot" style={{ background: '#C7CBE0' }}></span> Projected {money(goal.projected)}</span><span>Target {money(h.goal.target)}</span></div>
