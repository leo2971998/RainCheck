...
function Workspace({ household: h, transactions, notice, source }) {
  ...
  return <div className="app">
    <aside>
      ...
      <div className="side-foot"><div className="acct"><span className="avatar">AR</span><span>Alex Rivera<small>Partly funded</small></span></div>Everyday Checking · Savings<br />{sourceLabel}</div>
    </aside>
